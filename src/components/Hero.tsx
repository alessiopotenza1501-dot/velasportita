  ...
  return <section className="relative h-[600px] md:h-[700px] overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full flex items-center">
        <div className="max-w-2xl text-accent-foreground animate-fade-in">
          <h1 className="text-5xl md:text-7xl font-heading font-bold mb-6 leading-tight">Eleganza Italiana senza tempo</h1>
          <p className="text-xl md:text-2xl mb-8 font-body"> Stile raffinato. Made in Italy.</p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="/shop/men">
              <Button variant="hero" size="lg">​Uomo</Button>
            </a>
            <a href="/shop/women">
              <Button variant="hero-outline" size="lg">​Donna</Button>
            </a>
          </div>
        </div>
      </div>
